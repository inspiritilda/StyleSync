...
def seed():
    with app.app_context():
        ...
        print(user)
        db.session.add(Items(name="shirt",image_url="https://www.google.com",user =user))
        
        db.session.commit()
        item = db.session.query(Items).filter_by(id=1).first()
        print(item)
        print(item.user)
        db.session.add(Items(name="pants",image_url="https://www.google.com",user = user))
        db.session.add(Items(name="shoes",image_url="https://www.google.com",user = user))
        db.session.add(Items(name="hat",image_url="https://www.google.com",user = user))
        db.session.add(Items(name="gloves",image_url="https://www.google.com",user = user))
        db.session.add(Items(name="scarf",image_url="https://www.google.com",user = user))
